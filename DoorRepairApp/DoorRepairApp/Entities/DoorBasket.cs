...
namespace DoorRepairApp.Entities
{
    public class DoorBasket
    {
        ...
        /// </summary>
        public static Dictionary<Door, BuyItem> GetBasket { get; } = new Dictionary<Door, BuyItem>();
        ...
        public static void AddProductInBasket(Door product)
        {
        ...
        public static void SetCount(Door product, int count)
        {
            if (GetBasket.ContainsKey(product))
            {
                int k = count;
        ...
        public static void DeleteProductFromBasket(Door product)
        {
            if (GetBasket.ContainsKey(product))
            {
                GetBasket.Remove(product);
